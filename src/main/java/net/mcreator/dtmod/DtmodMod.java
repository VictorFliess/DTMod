...
@Mod("dtmod")
public class DtmodMod {
	public static final Logger LOGGER = LogManager.getLogger(DtmodMod.class);
	public static final String MODID = "dtmod";
